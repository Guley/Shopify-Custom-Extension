...
${errorInfo.componentStack}`);
  ...
  var Checkout_default = reactExtension(
    ...
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CustomNotes, {})
  );
  function CustomNotes() {
    const [custominfo] = useAttributeValues([
      "my custom info"
    ]);
    const [customInfo, setCustomInfo] = (0, import_react18.useState)("");
    const applyAttributeChange = useApplyAttributeChange();
    const submitHandler = () => __async(this, null, function* () {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "base", border: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      Button2,
      {
        overlay: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Modal2, { id: "my-modal", padding: true, title: "Custom info", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Form2, { onSubmit: () => submitHandler(), children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Grid2, { columns: ["50%", "50%"], spacing: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextField2, { label: "Custom Note", id: "custominfo", name: "custominfo", value: custominfo, onChange: (data) => setCustomInfo(data) }) }) }),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Icon2, { source: "discount" }),
          " Click On Me"
        ]
      }
    ) });
